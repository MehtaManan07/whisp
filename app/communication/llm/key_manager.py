...
from app.core.cache.service import get_key, set_key, increment_key
...
class APIKeyManager:
    ...
    def _increment_key_usage(self, key_index: int) -> int:
        ...
        new_count = increment_key(redis_key, 1)
        ...
        if new_count == 1:  # First increment of the day
            ...
            if redis_client.is_connected:
                try:
                    ...
                    redis_client.client.expire(redis_key, seconds_until_eod)
...
# Global instance
api_key_manager = APIKeyManager(daily_limit=config.open_router_daily_limit)
