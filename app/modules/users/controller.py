...
from app.core.dependencies import DatabaseDep, UserServiceDep
...
async def create_user(
    ...
    result: FindOrCreateResult = await user_service.find_or_create(db, user_data)
...
async def get_user_by_wa_id(
    ...
    user = await user_service.get_user_by_wa_id(db, wa_id)
    if not user:
...
async def get_all_users(
    ...
    users = await user_service.get_all_users(db, limit=limit, offset=offset)
